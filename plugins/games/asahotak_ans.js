...
var id = msg.from
if (!msg.quoted || !msg.quoted.fromMe || !msg.quoted.isBaileys || !/Ketik.*ao/i.test(msg.quoted.contentText)) return !0
this.asahotak = this.asahotak ? this.asahotak : {}
if (!(id in this.asahotak)) return msg.reply('🚩 Soal itu telah berakhir.')
if (msg.quoted.id == this.asahotak[id][0].id) {
let json = JSON.parse(JSON.stringify(this.asahotak[id][1]))
if (['.ao', 'Bantuan', ''].includes(msg.text)) return !0
